...
项目现已提供可玩的数字拼图和图片拼图模式。通过“上传图片”选择 JPG、JPEG 或 PNG 图片，程序会将其切分为可移动的拼图块；使用“显示数字”可在不重置当前游戏的情况下切回数字显示。
...
要玩图片拼图，请在菜单中选择“上传图片”，然后选择 JPG、JPEG 或 PNG 文件。当前排列和步数不会改变；选择“显示数字”可切回数字拼图显示。
...
包含 Swing 图形界面：显示数字或图片方块、处理图片加载和显示模式切换、提供游戏菜单，以及显示完成提示。
